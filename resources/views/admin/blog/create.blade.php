...
<form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data" class="admin-form" data-disable-on-submit>
    @csrf
    <div class="form-grid">
        <div class="form-card form-card--wide">
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" rows="12" class="form-textarea @error('content') is-error @enderror" required>{{ old('content') }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <input type="number" id="read_time_minutes" name="read_time_minutes" value="{{ old('read_time_minutes', 5) }}" min="1" class="form-input">
            </div>
            <div class="form-group">
                <label for="published_at">Publish Date</label>
                <input type="date" id="published_at" name="published_at" value="{{ old('published_at') }}" class="form-input">
                <small>Leave empty to save as draft</small>
            </div>
            <div class="form-group">
                <label for="image">Featured Image <span class="required">*</span></label>
                <input type="file" id="image" name="image" accept="image/*" required data-preview="image-preview">
