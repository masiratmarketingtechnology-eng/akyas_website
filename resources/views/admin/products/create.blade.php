...
<form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="admin-form" data-disable-on-submit>
    @csrf
    <div class="form-grid">
        <div class="form-card">
            <h2>Basic Info</h2>
            ...
            <div class="form-group">
                ...
                <input type="text" id="tagline" name="tagline" value="{{ old('tagline') }}" class="form-input @error('tagline') is-error @enderror">
                @error('tagline')<span class="field-error">{{ $message }}</span>@enderror
            </div>
            <div class="form-group">
                <label for="description">Description <span class="required">*</span></label>
                <textarea id="description" name="description" rows="5" class="form-textarea @error('description') is-error @enderror" required>{{ old('description') }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <textarea id="specs" name="specs" rows="6" class="form-textarea" placeholder="Capacity: 1000kg&#10;Material: U.V. Treated PP&#10;Safety Factor: 5:1&#10;Min Order: Bulk">{{ old('specs') }}</textarea>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <small>You can select multiple images. Recommended: 600x450px each</small>
